...
# Also after each outer loop iteration since the highest/lowest number (depending of the comparing sign) will be pushed to the last position.
...
# We can optimize the time complexity O(n) of this algorithm by breaking the loop if the order of the array have not changed after completing the inner loop.
